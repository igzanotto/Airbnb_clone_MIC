...
flat3 = Flat.new(title: 'Moon boat', price: 800, category: 'Yatch', number_of_guests: '8', user_id: user2.id, location: '250 Uruguay, Mar del Plata', description: 'The best choice to enjoy your summer surranded by friends in the middle of the ocean but close to the funnest night city')
