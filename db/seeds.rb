...
puts 'creando flats'
flat1 = Flat.create!(title: 'La Casita Loca', price: 200, category: 'House', number_of_guests: '5', user_id: user1.id, location: '455 San Andres, Mar del Plata', description: 'La casa mas linda de Mar del Plata que podes disfrutar con amigos o familia')
...
flat2 = Flat.create!(title: 'Departamento lux', price: 200, category: 'Apartment', number_of_guests: '2', user_id: user1.id, location: 'Rbla. Dr. Baltasar Brum 2772, 11800 Montevideo, Departamento de Montevideo, Uruguay', description: 'Departamento perfecto si tenes que viajar y trabajar con una buena vista')
...
flat3 = Flat.create!(title: 'El barco de Luna', price: 800, category: 'Yatch', number_of_guests: '8', user_id: user2.id, location: '250 Uruguay, Mar del Plata', description: 'Este yatch es ideal para divertirse con amigos en verano')
