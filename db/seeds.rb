...
puts 'creando flats'
flat1 = Flat.create!(title: 'La Casita Loca', price: 200, category: 'House', number_of_guests: '5', user_id: user1.id, location: '5869 Av. Patricio Peralta Ramos, Mar del Plata', description: 'La casa mas linda de Mar del Plata que podes disfrutar con amigos o familia')
...
flat2 = Flat.create!(title: 'Departamento lux', price: 200, category: 'Apartment', number_of_guests: '2', user_id: user1.id, location: '2772 Rbla. Dr. Baltasar Brum, Montevideo', description: 'Departamento perfecto si tenes que viajar y trabajar con una buena vista')
