...
flat2 = Flat.new(title: 'Aparment lux', price: 200, category: 'Apartment', number_of_guests: '2', user_id: user1.id, location: '2772 Rbla. Dr. Baltasar Brum, Montevideo', description: 'Your family will be close to everything when you stay at this centrally-located place. 10min Walk to the beach. 5min walk to Waterloo station from where you can go anywhere.', ratings: 5)
...
flat3 = Flat.new(title: 'Moon boat', price: 800, category: 'Yatch', number_of_guests: '8', user_id: user2.id, location: '250 Uruguay, Mar del Plata', description: 'The best choice to enjoy your summer surranded by friends in the middle of the ocean but close to the funnest night city', ratings: 4)
...
flat6 = Flat.new(title: 'Charming villa near San Pietro', price: 500, category: 'House', number_of_guests: '8', user_id: user1.id, location: 'Rome, Lazio, Italy', description: 'New building with concierge service 15 minutes walk from the Vatican museums and metro station A (Cyprus Vatican museums). Equipped with every comfort, with 50 Smart TV included with Netflix and Wi-Fi.Consisting of living room with kitchenette, double bedroom and large bathroom. Comfortable accommodation for tourism in central areas of Rome', ratings: 4)
